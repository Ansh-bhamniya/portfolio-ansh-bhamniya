...
export function FAQs() {
  ...
  return (
    <section
      ...
      className="scroll-mt-24 bg-muted py-16 transition-colors duration-300 md:py-24"
    >
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        ...
        <div className="mt-12">
          <Accordion
            type="single"
            collapsible
            className="bg-card ring-foreground/5 rounded-[var(--radius)] w-full border border-transparent px-8 py-3 shadow ring-1"
          >
            {faqItems.map((item) => (
